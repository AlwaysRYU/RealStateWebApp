  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <table class="table table-hover">
          <tbody>
            ...
            <tr id="tr-heigth"><td>내용</td><td v-html="$store.state.board.content" id="solid-content"></td></tr>
      ...
      <div class="modal-footer">
        <button v-show="$store.state.board.sameUser" @click="changeToUpdate" class="btn btn-sm btn-primary btn-outline" data-dismiss="modal" type="button">글 수정하기</button>
        <button v-show="$store.state.board.sameUser" @click="changeToDelete" class="btn btn-sm btn-warning btn-outline" data-dismiss="modal" type="button">글 삭제하기</button>
      </div>
    </div>
  </div>
</div>
