...
<div>
  ...
  <div class="sidebar-inner px-4 pt-3">
    <div class="user-card d-flex d-md-none align-items-center justify-content-between justify-content-md-center pb-4">
      <div class="d-flex align-items-center">
        ...
        <div class="d-block">
          ...
          <a href="../../public/pages/examples/sign-in.html" class="btn btn-secondary btn-sm d-inline-flex align-items-center">
    ...
    <ul class="nav flex-column pt-3 pt-md-0">
      <li class="nav-item">
        <a href="../../index.html" class="nav-link d-flex align-items-center">
          <span class="sidebar-icon">
            <img src="../../public/assets/img/brand/light.svg" height="20" width="20" alt="Volt Logo">
          </span>
          <span class="mt-1 ms-1 sidebar-text">Volt Overview</span>
        </a>
      </li>
      <li class="nav-item  active ">
        <a href="../../public/pages/dashboard/dashboard.html" class="nav-link">
          <span class="sidebar-icon">
      ...
      <li class="nav-item ">
        <a href="../../public/pages/settings.html" class="nav-link">
          <span class="sidebar-icon">
      ...
      <li class="nav-item">
        ...
        <div class="multi-level collapse "
          ...
          <ul class="flex-column nav">
            <li class="nav-item ">
              <a class="nav-link" href="../../public/pages/tables/bootstrap-tables.html">
      ...
      <li class="nav-item">
        ...
        <div class="multi-level collapse " role="list"
          ...
          <ul class="flex-column nav">
            <li class="nav-item">
              <a class="nav-link" href="../../public/pages/examples/sign-in.html">
                <span class="sidebar-text">Sign In</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../../public/pages/examples/sign-up.html">
                <span class="sidebar-text">Sign Up</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../../public/pages/examples/forgot-password.html">
                <span class="sidebar-text">Forgot password</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../../public/pages/examples/reset-password.html">
                <span class="sidebar-text">Reset password</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../../public/pages/examples/lock.html">
                <span class="sidebar-text">Lock</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../../public/pages/examples/404.html">
                <span class="sidebar-text">404 Not Found</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../../public/pages/examples/500.html">
      ...
      <li class="nav-item">
        <a href="https://themesberg.com" target="_blank" class="nav-link d-flex align-items-center">
          <span class="sidebar-icon">
            <img src="../../public/assets/img/themesberg.svg" height="20" width="28" alt="Themesberg Logo">
          </span>
...
export default {
  ...
  // need only form development
  // v-bind:src="userInfo.userProfileImageUrl" 로 하면 이미지 경로가 /img/...png 형태가 되는데 npm run serve 5500 에서 찾을 수 없음
  // 운영서버에서는 그게 맞음.
  // 대신 require 를 사용해서 테스트하고 이를 위해 computed 를 하나 만듦
  // require(url) <== image 경로 및 파일 Hard Coding
